                ...
                <div class="owl-carousel owl-theme">
                    <div class="client row ">
                        ...
                        <div class="col-lg-7  about-client ">
                            ...
                            <p class="para">This Website Looking Good.</p>
                        </div>
                    ...
                    <div class="client row">
                        <div class="col-lg-4 col-md-12 client-img">
                            <img src="img/clients/sabab1.gif" alt="img1" class="img-fluid rounded">
                        </div>
                        <div class="col-lg-7 col-md-12 about-client">
                            <h4 class="text-uppercase">Sabab Zulfiker</h4>
  ...
  <div class="client row">
                    ...
                    <div class="client row">
                        ...
                        <div class="col-lg-7 col-md-12 about-client">
                            ...
                            <p class="para">Lorem ipsum dolor, sit amet consectetur nt.</p>
                        </div>
                        <div class="col-lg-1 col-md-12"></div>
                    </div>
      ...
      <div class="client row">
        ...
        <section class="subscribe-us-area py-4 mt-4">
            <div class="container subscribe"2>
                <div class="row">
                    <div class="col-lg-12 text-center subscribe-title">
                        <h4 class="text-uppercase  text-warning wow bounceInRight "  data-wow-duration="5s">Get Your Commens anywhere</h4>
...
<div class="meet-member text-center py-2">
   <div class="container">
      <h2 class="text-center text-light py-4 bg-danger" >CORE TEAM</h2>
        <div class="row">
     ...
     <div class="col-md-6 text-center mt-4">
         <div class="coreman-icon ">
              <img src="img/post/ceo.jpg"  class="img-fluid w-50 rounded-circle" >
                  ...
                  <h2 class="text-danger  ">Kamrul Hassan</h2>    

          <strong><h6 class="text-info"  >Web Design-Developer</h6></strong>
           <strong><h5>CEO </h5></strong>   
           <ul> 
            ...
            <div class="coreman-icon ">
              <img src="img/post/emon3.jpg" class="img-fluid w-50 rounded-circle">
               <h3 class="text-danger" >Emon Khondokar</h3>
                   <strong><p class="text-info">.........</p></strong>
