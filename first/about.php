                    ...
                    <form class="w-50">
                        <div class="row d-flex flex-row flex-wrap">
                            <div class="col input-textbox">
                                <input type="text" id="txtemail" class="form-control" placeholder="Write....">
                            </div>
                            <div class="col">
                                <div class="btn-submit">
                                    <button type="submit" class="btn btn-success float-right">Sent</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<div class="meet-member text-center py-2">
   <div class="container">
      <h2 class="text-center py-4 bg-muted" >CORE TEAM</h2>
        <div class="row">
