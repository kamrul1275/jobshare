...
<div class="card-deck">
  <div class="card text-center text-light">
    <img src="img/icon/workspace.png" class=" wow bounceInRight "  data-wow-duration="4s" class="img-fluid" alt="...">
    <div class="card-body">
  ...
  <div class="card text-center text-light ">
    <img src="img/icon/creative-tools (1).png"  class="wow bounceInDown  "  data-wow-duration="5s" class="img-fluid" alt="...">
    <div class="card-body">
  ...
  <div class="card text-center text-light " >
    <img src="img/icon/networking.png"  class="wow bounceInDown" data-wow-duration="5s" class="img-fluid" alt="..." >
    <div class="card-body">
   ...
   <div class="card text-center text-light ">
    <img src="img/icon/domain.png" class="wow bounceInLeft" data-wow-duration="4s"  class="img-fluid" alt="...">
    <div class="card-body">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <h4> Do U Need Website  right? We got you!.</h4>
...
<div class="col-lg-4">
  <div class="form-group mb-0">
    <input type="name" placeholder="Name" name="name " class="form-control form-control-lg">
  </div>
</div>
...
<div class="col-lg-4">
 <button class="btn btn-primary btn-block btn-lg">Sent</button>
</div>
...
<div class="photo-gallery py-5  " uk-lightbox>
  ...
  <div class="row pt-4" >
    <div class="col-md-4">
      ...
      <div class="col-md-4">
        <div class="photo-card">
          <a href="img/photo gullery/gallery4.gif">
