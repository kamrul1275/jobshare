  ...
  <?php
      ...
      {  require_once("config.php");
        ...
        if(mysqli_num_rows($result)>0)
        {
          ...
          alert('Wrong Username or Password & wait!')
            ...
            <div class="custom-container">
                <div class="row">
                    <div class="col-4">
                        <div class="team-box">
                            <div class="member-img">
                                <img src="images/team/kamrul.jpg" alt="" class="img-fluid">
                    ...
                    <div class="col-4">
                        <div class="team-box">
                            <div class="member-img">
                                <img src="images/team/sabbir1.jpg" alt="" class="img-fluid">
                    ...
                    <div class="col-4">
                        <div class="team-box">
                            <div class="member-img">
                                <img src="images/team/shuvo1.jpg" alt="" class="img-fluid">
